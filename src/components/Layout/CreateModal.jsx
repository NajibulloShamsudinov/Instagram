...
import { Button, TextField } from "@mui/material";<<<<<<< amir-branch
          ...
          <div>
            ...
            <div style={{ display: img == null ? "none" : "block" }}>
              <div className="flex pr-[5%]   items-center justify-between pt-[3%] ">
                ...
                <p onClick={() => alert("HOZIR LOGIKAI POST NAVISHTA NASHUDAAST")} className="  cursor-pointer  text-[#697aae] ">Next</p>
              </div>
            </div>
