  ...
  return (
    <div>
      <Modal 
        open={openAddStr}>
      <Box sx={style}>
    <h1 className="text-[30px]">Add Story</h1><br />
    <input type="file" onChange={handelChange} /> <br />
    <img src={img} alt="" />
    <div className='flex gap-[10px] mt-[50px]'>
    <Button onClick={()=>{handelSubmit(),setOpenAddStr(false)}}>POST</Button>
    <Button onClick={()=>dispatch(setOpenAddStr(false))}>close</Button>
    </div>
      </Box>
    </Modal>
    </div>
