                  ...
                  <div className="mt-[30px] ml-[100px]">
                    ...
                    <div className="flex gap-[38px] mt-[20px]">
                      <div className="flex gap-[7px]">
                        {/* Исправить */}
                        <h1 className="">
                          {profileById && profileById.postCount}
                        </h1>
        ...
        <div className="add-btn">
          <div className="border-[2px] w-[90px] h-[90px] flex justify-center items-center ml-[200px] mt-[40px]  rounded-[100%] ">
            <div className="bg-[#FAFAFA] px-[3px] py-[2px] flex justify-center items-center h-[83px] w-[83px] rounded-[100%] ">
              <h1
                onClick={handleOpen}
                className="text-[76px] pb-[20px] cursor-pointer text-[#c8c9cb] font-thin"
              >
                +
              </h1>
            </div>
          </div>
          <h1 className="ml-[215px] text-[12px] font-[500] pt-[5px]">
            Добавить
          </h1>
        </div>
      </div>
      ...
      <div className="w-[80%] justify-center gap-[70px] mt-[0px] flex m-auto ">
        <button onClick={() => setVisit("post")}>
          ...
          <div className="flex mt-[15px] gap-[5px] text-[#737373] items-center">
            ...
            <h1 onClick={() => setLink("publ")} className="hover:text-[black]">
              Публикации
            </h1>
          </div>
        </button>
        <button onClick={() => setVisit("save")}>
          ...
          <div className="flex gap-[5px] mt-[15px]  text-[#737373] items-center">
            ...
            <h1 onClick={() => setLink("saved")} className="hover:text-[black]">
              Сохраненное
            </h1>
          </div>
        </button>
