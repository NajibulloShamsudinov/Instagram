    ...
    <div className="">
      <div className=" flex justify-center ">
        ...
        <div className="mt-[40px] ml-[60px]">
          <div className="setting w-[613px]  items-center  flex">
            <h1 className="pr-[25px] text-[20px] font-[400]">alijjon89</h1>
          ...
          <div className="flex gap-[38px] mt-[20px]">
            <div className="flex gap-[7px]">
              ...
              <h1 onClick={()=>setPost()} className="hover:text-[#e3e1e1]"> публикаций</h1>
            </div>
            <div className="flex gap-[7px]">
      ...
      <div className="border-[2px] w-[90px] h-[90px] flex justify-center items-center ml-[180px] mt-[20px]  rounded-[100%] ">
        <div className="bg-[#FAFAFA] px-[3px] py-[2px] flex justify-center items-center h-[83px] w-[83px] rounded-[100%] ">
          <h1 className="text-[76px] pb-[20px] cursor-pointer text-[#c8c9cb] font-thin">+</h1>
        </div>
      </div>
      ...
      <div className="w-[80%] justify-center gap-[70px] mt-[15px] mb-[300px]  flex m-auto "   >
        ...
        <div className="flex gap-[5px] text-[#737373] items-center">
          <svg className="w-[15px] pt-[3px] h-[15px]" aria-label="" class="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12"><title></title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
          <h1>Сохраненное</h1>
        </div>
        </button>
