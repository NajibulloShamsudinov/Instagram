...
import { getProfile, getUser, getPostById, getSubsciption, getSubsciptions, getProfileById, addFollowing,unFollowing } from '../../api/profile/profile'
    ...
    return (
        <div className="">
            <div className="">
                <div className="wrapper-user max-w-[1280px] mx-auto">
                    ...
                    <div className="flex ml-[80px] justify-center ">
                        ...
                        <div className="mt-[20px]">
                            <img className="rounded-[100%] object-cover w-[150px] h-[150px]" src={`${import.meta.env.VITE_APP_FILES_URL}${profileById.image}`} alt="img" />
                        </div>

                        <div className="mt-[30px] ml-[100px]">
                            <div className="setting w-[613px]  items-center  flex">
                                <h1 className="pr-[25px] text-[20px] font-[400]">{profileById.userName}</h1>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        console.log( subsciption.filter((e) =>
                                ...
                                <button className=" bg-[#EFEFEF] font-[500] text-[14px] px-[16px] h-[32px] hover:bg-[#e3e1e1] ml-[8px] rounded-[8px]">Отправить сообщение</button>
                ...
                <div className="w-[80%] mt-[130px] border-b-[1.5px] border-[#d1d0d0] m-auto">
                </div>
